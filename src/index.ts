// ! 1. Définir la structure d'une image
...
const gridContainer = document.getElementById('gallery-grid') as HTMLDivElement;
...
function renderGallery(): void {
  ...
  if (btnNext) btnNext.disabled = currentIndex + itemsPerPage >= images.length;
}
